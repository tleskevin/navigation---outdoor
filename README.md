...
Whisper 語音辨識：捨棄傳統關鍵字觸發，整合 OpenAI Whisper 模型，實現高準確度的語音轉文字 (STT)，即使在戶外噪音環境下也能精準捕捉使用者指令。
...
YOLO 即時邊緣運算：系統預留 YOLO 偵測接口，用於在導航過程中進行即時障礙物辨識與路口紅綠燈狀態偵測，將 AI 視覺從單純的影像記錄提升至主動避障層次。
